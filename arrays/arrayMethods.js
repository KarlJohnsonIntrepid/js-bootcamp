...
//Reduce  -reduces the array down to one....

//Sum
let arr11 = createNumberArray();
let sum = arr11.reduce((sum, num) => sum + num);
console.log(sum);

//Min
let arr12 = createNumberArray();
let min = arr12.reduce((min, num) => (min >= num ? num : min));
console.log(min);

//Max
let arr13 = createNumberArray();
let max = arr13.reduce((max, num) => (num > max ? num : max));
console.log(max);
